...
namespace ElasticTests
{
    public class Http_QueriesTests : QueriesTestsBase
    {
        ...
        #region Http_Query_Star_Wars_Slop_1_Test

        [Fact]
        public async Task Http_Query_Star_Wars_Slop_1_Test()
        {
            await BulkInserAsync();
        ...
        #endregion // Http_Query_StHttp_Query_Star_Wars_Slop_1_Testar_Wars_Test
