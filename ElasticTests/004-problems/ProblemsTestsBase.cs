...
{
    public class ProblemsTestsBase
    {
        const string ENDPOINT = "http://localhost:9200/";
        protected const string BASE_PATH = "004-problems";
        ...
        public ProblemsTestsBase(ITestOutputHelper outputHelper, string defaultIndex)
        {
